...
class ClientDashboard(ctk.CTkFrame):
    def __init__(self, master, user_id, logout_cb):
        ...
        self.welcome_label = ctk.CTkLabel(self.content_area, text="Welcome, Client!", font=("Arial", 22, "bold"))
        self.welcome_label.pack(anchor="w", padx=30, pady=(30, 10))

        self.sub_label = ctk.CTkLabel(self.content_area, text="Manage your projects and discover top talent.",
        ...
        self.card1_title = ctk.CTkLabel(self.card1, text="Active Jobs", font=("Arial", 12), text_color="gray")
        self.card1_title.pack(pady=(10, 2))
        self.card1_val = ctk.CTkLabel(self.card1, text="0", font=("Arial", 20, "bold"))
        ...
        self.card2_title = ctk.CTkLabel(self.card2, text="Total Spent", font=("Arial", 12), text_color="gray")
